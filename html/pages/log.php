...
?>
    <div class="bodyEditUser" >
        ...
        <form action="../scripts/login.php" method="POST">
            ...
            <label class="lblEditUser" for="login"style='margin-left:0.2rem;'>Password:</label>
            ...
            <div class='box2'>
            <p>Forgot Password?<a href="../pages/confirmPW.php" class='myA'> Reset Password </a></p>
            <p>Don't have an account?</p>
            <p style='margin-top:-20px;'>Create One<a href="../pages/registar.php" class='myA'> Register </a></p>
            </div>
        </form>
