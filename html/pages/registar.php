    ...
    <main>
        <section>
            <div class="column is-4 is-offset-4">
                <h3 class="title myA" style='font-size:2rem;'> Register </h3>
                <BR>
        <?php
    ...
    <div class="bodyEditUser" >
        <div class="containerEditUser" style='overflow-x:0;'>
                <form action="../scripts/reg.php" method="POST">
                    ...
                    <div>
                        <label class="lblEditUser" style='margin-left:0.2rem;'>Name:</label>
                        <input name="nome" class="inputEditUser" placeholder="Name" type="text" required>
                    </div>
                    <div>
                        <label class="lblEditUser" style='margin-left:0.2rem;'>Password:</label>
                        <input class="inputEditUser" placeholder="Password"type="password" name="pass" id='password' oninput="checkPasswordStrength(this.value)" required> <br>

                         <div id="password-strength" style='text-align:center;' ></div>
                    </div>
                    <button type="submit" class="btnEditUser"> Create </button>
                </form>
        
                    <a href="log.php" class='MyA'> Back </a>
